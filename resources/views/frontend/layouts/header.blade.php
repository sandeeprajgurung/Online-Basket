                ...
                <li class="nav-item {{ Request::is('/') ? 'active' : '' }}"><a href="{{ route('home') }}" class="nav-link">Home</a></li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown04">
                            <a class="dropdown-item" href="shop.html">Vegitables</a>
                            <a class="dropdown-item" href="wishlist.html">fruits</a>
                            <a class="dropdown-item" href="product-single.html">Dried</a>
                    ...
                    <li class="nav-item {{ Request::is('cart') ? 'active' : '' }} cta cta-colored"><a href="{{ route('cart') }}" class="nav-link"><span
